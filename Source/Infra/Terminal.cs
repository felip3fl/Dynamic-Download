...
namespace Infra
{
    public class Terminal
    {
        ...
        readonly string parameters = "--check-formats --sponsorblock-remove all -f \"bestvideo[height<=1440]+ba[format_note*=original]\" -o \"%(channel)s - %(title)s.%(ext)s\" --all-subs --embed-subs --add-metadata";
